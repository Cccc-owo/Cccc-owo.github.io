...
2. 如果 **RAM ≥ 6.0GB** *（推荐值：大于等于8）*，恭喜你，电脑配置 **足以**支持你开服。  

   如果 **4.0GB ≤ RAM ≤ 6.0GB**，也恭喜你，还是 **有可能**开服的。  

   至于运行内存 *小于4.0GB*，我只能说：真不知道你是 **怎么**把这台电脑 **用下去的**......

   **图示：**

   <img src="https://raw.githubusercontents.com/Cccc-owo/Blog_Pictures/master/post_2db743f6/1.png" alt="RAM" style="zoom: 80%;" />
...
### 1.下载JAVA
  ...
  到了我们喜闻乐见的下载环节了，由于官方下载速度太慢，于是我决定用镜像的方法下载。（ **不懂没关系，继续向下看**）  
...
![4](https://raw.githubusercontents.com/Cccc-owo/Blog_Pictures/master/post_2db743f6/4.png)

### 2.结束了?

1. 左键双击「Start.bat」等待五秒左右，不用管命令行(下称 **CMD**)出现什么字，按下任意键将其关闭。  
2. 现在可见文件夹里又 **多了许多文件**，不要慌，找到 **「eula.txt」**并打开。你可能会看到 **如下**内容👇  

```
#By changing the setting below to TRUE you are indicating your agreement to our EULA (https://account.mojang.com/documents/minecraft_eula).
#Sat Feb 29 20:10:04 CST 2020
eula=false
```
...
```
  ...
  ![5](https://raw.githubusercontents.com/Cccc-owo/Blog_Pictures/master/post_2db743f6/5.png)
4. 保存并关闭文档，此时再次打开「Start.bat」。等待一分钟左右的时间， **如果正确按步骤来，那服务器已经 *好了*。** *(我好了（挨打）)*
    ![6](https://raw.githubusercontents.com/Cccc-owo/Blog_Pictures/master/post_2db743f6/6.png)
5. 如果是盗版玩家，请用「记事本」打开「server.properties」，更改44行的「true」为「false」。如下图  
    ![New](https://raw.githubusercontents.com/Cccc-owo/Blog_Pictures/master/post_2db743f6/7.png)
...
> /op <玩家>          给某个玩家OP
> /deop <玩家>         取消某个玩家的OP
> /gamemode survival「或」creative「或」adventure「或」spectator <玩家>
...
2. 在 **「CMD」**中输入**「ipconfig」**，找到「本地连接」或「以太网」中的**「IPv4地址」**，把右边的一串例如**「192.168.x.xxx」** *或是其他的IP地址*的数字记下来，这就是 **你的内网IP地址**。  
    ![懂自懂](https://raw.githubusercontents.com/Cccc-owo/Blog_Pictures/master/post_2db743f6/8.png)
...
![OHHHH!!!](https://raw.githubusercontents.com/Cccc-owo/Blog_Pictures/master/post_2db743f6/9.png)
...
![New](https://raw.githubusercontents.com/Cccc-owo/Blog_Pictures/master/post_2db743f6/10.png)
